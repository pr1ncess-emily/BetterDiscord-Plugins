...
module.exports = class StatusScheduler {
    ...
    start() {
        ...
        if (!global.ZeresPluginLibrary) {
            return window.BdApi.alert("Library missing", "A library required for this program to run is missing. You can install it from <a href=\" //raw.githubusercontent.com/rauenzi/BDPluginLibrary/master/release/0PluginLibrary.plugin.js\" target=\"_blank\">here</a>.");
        }
    }
